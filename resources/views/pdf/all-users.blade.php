...
<head>
    <meta charset="UTF-8">
    <title>Relatório de Usuários - PontoCerto</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="header">
        <div class="header-content">
            <div class="logo-section">
                ...
                <div class="report-title">Relatório Geral de Usuários</div>
            </div>
            <div class="report-type">
                <div class="report-type-label">Tipo de Relatório</div>
                <div class="report-type-value">Todos os Usuários</div>
            </div>
        </div>
    </div>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th style="width: 12%;">Registros</th>
                    <th style="width: 16%;">Cadastrado em</th>
                </tr>
            </thead>
            <tbody>
